...
export function HeroSearch() {
  ...
  return (
    <div className="w-full border-b border-[#0d0d0d]/10 bg-[#f9f9f9]">
      <form
        onSubmit={handleSubmit}
        className="mx-auto flex max-w-[1440px] items-center gap-3 p-4 md:px-[50px] md:py-5"
      >
        ...
        <button
          type="submit"
          className="shrink-0 rounded-[8px] bg-[#0d0d0d] px-5 py-2 text-sm font-medium text-white transition-colors hover:bg-[#161616]"
        >
          Buscar
        </button>
      </form>
