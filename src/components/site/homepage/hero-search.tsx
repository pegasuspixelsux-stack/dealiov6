...
export function HeroSearch() {
  ...
  return (
    <div className="w-full bg-[#f9f9f9] p-4 md:px-[50px] md:py-5">
      <form
        onSubmit={handleSubmit}
        className="mx-auto flex max-w-[1440px] items-center gap-3 rounded-full border border-[#0d0d0d]/15 bg-white px-5 py-2 md:px-6 md:py-3"
      >
